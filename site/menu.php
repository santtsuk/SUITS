  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Suits</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
            ...
            <ul class="navbar-nav ms-3">
              <li class="nav-item">
                <a class="nav-link" href="dashboard.php?r=cadFuncionario">
                  <span class="nav-link-text ms-1">Novo Funcionário</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="dashboard.php?r=telaFuncionarios">
                  <span class="nav-link-text ms-1">Lista de Funcionários</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
        <a class="nav-link" href="dashboard.php" data-bs-toggle="collapse" data-bs-target="#submenuProcesso" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="12px" height="12px">
            ...
            <span class="nav-link-text ms-1">Processo</span>
          </a>
          <div class="collapse" id="submenuProcesso" style="background-color:#d1d1d1;">
            <ul class="navbar-nav ms-3">
              <li class="nav-item">
                <a class="nav-link" href="dashboard.php?r=cadProcesso">
                  <span class="nav-link-text ms-1">Novo Processo</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="dashboard.php?r=telaProcessos">
                  <span class="nav-link-text ms-1">Lista de Processos</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="dashboard.php?r=minhaAgenda">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <span class="nav-link-text ms-1">Minha Agenda</span>
          </a>
        </li>
      </ul>
  </aside>